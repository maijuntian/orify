...
import 'interceptors/m_token_interceptor.dart';
...
class MHttpManager {
  ...
  final MTokenInterceptors _tokenInterceptors = new MTokenInterceptors();
  ...
  setRegion(String region){
    _tokenInterceptors.region = region;
  }

  setVersion(String version){
    _tokenInterceptors.version = version;
  }

  setGps(String longitude, String latitude){
    _tokenInterceptors.latitude = latitude;
    _tokenInterceptors.longitude = longitude;
  }

  setDeviceId(String deviceId){
    _tokenInterceptors.deviceId = deviceId;
  }
}

final MHttpManager mHttpManager = new MHttpManager();
